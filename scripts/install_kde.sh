...
curl -o $HOME/.local/share/konsole/github_dark_default.colorscheme https://raw.githubusercontent.com/projekt0n/github-theme-contrib/main/themes/konsole/github_dark_high_contrast.colorscheme
